...
[Making something scriptable](Lib/KJX.Scripting/README.md#making-something-scriptable) is the
...
See [KJX.Scripting](Lib/KJX.Scripting/README.md) for the design, and
[kjx-instrument](python/README.md) for the Python client.
