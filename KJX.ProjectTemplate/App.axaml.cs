...
using KJX.ProjectTemplate.Models;
using KJX.ProjectTemplate.ViewModels;
...
public partial class App : Application
{
    ...
    private void InitAutofac()
    {
        ...
        using var reader = XmlReader.Create(Assembly.GetExecutingAssembly().GetManifestResourceStream("KJX.ProjectTemplate.nlog.config"));
